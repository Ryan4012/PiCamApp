...
**Short-Term**
- Complete radar-based motion detection logic
- Trigger video recording on motion events
- Improve Swift UI/UX

**Medium-Term**
- Push notifications for motion detection
- Video clip storage and playback
- Improved authentication (JWT or OAuth-style tokens)

**Long-Term**
- Multiple camera support
- Role-based access control
- Cloud backup or hybrid cloud integration
- Move toward WebRTC or lower-latency streaming
